...
class DiffusionCLIP(object):
    ...
    def clip_finetune(self):
        ...
        if self.config.data.dataset == "LSUN":
            if self.config.data.category == "bedroom":
                url = "https://heibox.uni-heidelberg.de/f/f179d4f21ebc4d43bbfe/?dl=1/bedroom_princess_t500.pth/bedroom_princess_t500.pth"
    ...
    def clip_finetune_eff(self):
        ...
        if self.config.data.dataset == "LSUN":
            if self.config.data.category == "bedroom":
                url = "https://heibox.uni-heidelberg.de/f/f179d4f21ebc4d43bbfe/?dl=1/bedroom_princess_t500.pth"
            elif self.config.data.category == "church_outdoor":
                url = "https://image-editing-test-12345.s3-us-west-2.amazonaws.com/checkpoints/church_outdoor.ckpt"
        elif self.config.data.dataset == "CelebA_HQ":
            url = "https://image-editing-test-12345.s3-us-west-2.amazonaws.com/checkpoints/celeba_hq.ckpt"
